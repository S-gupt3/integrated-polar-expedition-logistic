...
const navItems = [{ href: 'index.html', page: 'dashboard', label: 'Dashboard' }, { href: 'assets.html', page: 'assets', label: 'Assets' }, { href: 'inventory.html', page: 'inventory', label: 'Inventory' }, { href: 'analytics.html', page: 'analytics', label: 'Analytics' }, { href: '../../drift mapping/index.html', page: 'drift', label: 'Drift mapping' }];
