...
class PLOROPSIS_API {
    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            const mapKeys = (item) => {
                ...
                if (mapped.change === undefined) mapped.change = 0;
                return mapped;
            };
    ...
    async getStations() { return this.get(this.endpoints.stations); }
    async getStation(stationId) { return this.get(this.endpoints.station(stationId)); }
    async getAssets() { return this.get(this.endpoints.assets); }
    async getAsset(assetId) { return this.get(this.endpoints.asset(assetId)); }
    async createAsset(assetData) { return this.post(this.endpoints.assets, assetData); }
    async deleteAsset(assetId) { return this.delete(this.endpoints.asset(assetId)); }
    async getInventory() { return this.get(this.endpoints.inventory); }
    async getLowStockItems() { return this.get(this.endpoints.inventoryLowStock); }
    async addStock(inventoryId, quantityDelta) { return this.post(this.endpoints.inventoryAddStock(inventoryId), { quantity_delta: quantityDelta }); }
    async updateStock(inventoryId, quantityDelta) { return this.post(this.endpoints.inventoryAddStock(inventoryId), { quantity_delta: quantityDelta }); }
    async deleteInventoryItem(inventoryId) { return this.delete(`/api/inventory/${inventoryId}`); }
    async getConsumptionLogs() { return this.get(this.endpoints.consumptionLogs); }
    async createConsumptionLog(logData) { return this.post(this.endpoints.consumptionLogs, logData); }
    async getInventoryWithDoA() { return this.get(this.endpoints.inventoryDoA); }
    async getAssetsRegistry() { return this.get(this.endpoints.assetsRegistry); }
    async getDriftStatus() { return this.get(this.endpoints.driftStatus); }
    async getDriftStations() { return this.get(this.endpoints.driftStations); }
    ...
    async checkHealth() { return this.get(this.endpoints.health); }
